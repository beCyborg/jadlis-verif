...
Веб-проверка первоисточников внутри Fable-верификатора использует инструменты плагина `search` (Brave, Firecrawl), если он установлен; без него verif работает на Codex и Grok.
