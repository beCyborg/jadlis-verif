...
Релизы и теги (`jadlis-verif--vX.Y.Z`) делает владелец. Тексты и код написаны вместе с Claude Code; за содержание отвечает владелец.
...
Releases and tags (`jadlis-verif--vX.Y.Z`) are cut by the owner. Text and code are written together with Claude Code; the owner is accountable for the content.
